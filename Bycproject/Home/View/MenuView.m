...
-(void)setuplayout
{
    ...
    [weakSelf.chooseBtn1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakSelf);
        make.top.equalTo(weakSelf.view1.mas_bottom).with.offset(37);
        make.width.mas_offset(109*W_SCREEN);
        make.height.mas_offset(61);
        
    }];
    [weakSelf.chooseBtn0 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(weakSelf.chooseBtn1.mas_left).with.offset(-13);
        make.top.equalTo(weakSelf.chooseBtn1);
        make.width.mas_offset(109*W_SCREEN);
        make.height.mas_offset(61);
    }];
    [weakSelf.chooseBtn2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(weakSelf.chooseBtn1.mas_right).with.offset(13);
        make.top.equalTo(weakSelf.chooseBtn1);
        make.width.mas_offset(109*W_SCREEN);
        make.height.mas_offset(61);
    }];
...
-(UIImageView *)img0
{
    if(!_img0)
    {
        ...
        _img0.image = [UIImage imageNamed:@"icon_baojia"];
    }
    return _img0;
}
...
-(UIImageView *)img1
{
    if(!_img1)
    {
        ...
        _img1.image = [UIImage imageNamed:@"icon_zhuangxiu2"];
    }
    return _img1;
}
...
-(UIImageView *)img2
{
    if(!_img2)
    {
        ...
        _img2.image = [UIImage imageNamed:@"icon_jiancai-1"];
    }
    return _img2;
}
...
-(UIImageView *)img3
{
    if(!_img3)
    {
        ...
        _img3.image = [UIImage imageNamed:@"icon_anli"];
...
-(UIImageView *)img4
{
    if(!_img4)
    {
        ...
        _img4.image = [UIImage imageNamed:@"icon_sheji"];
    }
    return _img4;
}
...
-(UIButton *)chooseBtn0
{
    if(!_chooseBtn0)
    {
        ...
        [_chooseBtn0 setImage:[UIImage imageNamed:@"icon_3d"] forState:normal];
    }
    return _chooseBtn0;
}
...
-(UIButton *)chooseBtn1
{
    if(!_chooseBtn1)
    {
        ...
        [_chooseBtn1 setImage:[UIImage imageNamed:@"icon_xyong"] forState:normal];
    }
    return _chooseBtn1;
}
...
-(UIButton *)chooseBtn2
{
    if(!_chooseBtn2)
    {
        ...
        [_chooseBtn2 setImage:[UIImage imageNamed:@"icon_shigong"] forState:normal];
    }
    return _chooseBtn2;
}
